...
function toggleValve(valve) {
    ...
    // Automatically start simulation if both V2 and V3 are closed
    if (valve2.dataset.open === 'false' && valve3.dataset.open === 'false') {
        startPump();
    }
}
...
function startPump() {
    if (valve2.dataset.open === 'false' && valve3.dataset.open === 'false') {
        ...
        alert("Please close V2 and V3 before starting the pump!");
    }
}
